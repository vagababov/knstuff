...
flags.DEFINE_integer('step_count', 100, 'Max number of points for plotting', lower_bound=5, upper_bound=200)
...
def main(argv):
  ...
  print("Available: ", avl_cap)
  exc_cap = avl_cap-FLAGS.tbc
  print("Excess   : ", exc_cap)
